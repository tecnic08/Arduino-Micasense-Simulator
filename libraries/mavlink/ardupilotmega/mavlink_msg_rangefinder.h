...
typedef struct __mavlink_rangefinder_t {
 ...
 float distance_2; /*< [m] distance in meters*/
 float voltage_2; /*< [V] raw voltage if available, zero otherwise*/
}) mavlink_rangefinder_t;

#define MAVLINK_MSG_ID_RANGEFINDER_LEN 16
#define MAVLINK_MSG_ID_RANGEFINDER_MIN_LEN 16
#define MAVLINK_MSG_ID_173_LEN 16
#define MAVLINK_MSG_ID_173_MIN_LEN 16

#define MAVLINK_MSG_ID_RANGEFINDER_CRC 62
#define MAVLINK_MSG_ID_173_CRC 62
...
#define MAVLINK_MESSAGE_INFO_RANGEFINDER { \
    ...
    {  { "distance", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_rangefinder_t, distance) }, \
         ...
         { "distance_2", NULL, MAVLINK_TYPE_FLOAT, 0, 8, offsetof(mavlink_rangefinder_t, distance_2) }, \
         { "voltage_2", NULL, MAVLINK_TYPE_FLOAT, 0, 12, offsetof(mavlink_rangefinder_t, voltage_2) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_RANGEFINDER { \
 ...
 * @param distance_2 [m] distance in meters
 * @param voltage_2 [V] raw voltage if available, zero otherwise
...
{
    return mavlink_msg_rangefinder_pack(system_id, component_id, msg, rangefinder->distance, rangefinder->voltage, rangefinder->distance_2, rangefinder->voltage_2);
}
...
{
    return mavlink_msg_rangefinder_pack_chan(system_id, component_id, chan, msg, rangefinder->distance, rangefinder->voltage, rangefinder->distance_2, rangefinder->voltage_2);
}
...
static inline void mavlink_msg_rangefinder_send(mavlink_channel_t chan, float distance, float voltage, float distance_2, float voltage_2)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_RANGEFINDER_LEN];
    _mav_put_float(buf, 0, distance);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_rangefinder_send(chan, rangefinder->distance, rangefinder->voltage, rangefinder->distance_2, rangefinder->voltage_2);
#else
 ...
 */
static inline void mavlink_msg_rangefinder_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float distance, float voltage, float distance_2, float voltage_2)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field distance_2 from rangefinder message
 *
 * @return [m] distance in meters
 */
static inline float mavlink_msg_rangefinder_get_distance_2(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  8);
}

/**
 * @brief Get field voltage_2 from rangefinder message
 *
 * @return [V] raw voltage if available, zero otherwise
 */
static inline float mavlink_msg_rangefinder_get_voltage_2(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_rangefinder_decode(const mavlink_message_t* msg, mavlink_rangefinder_t* rangefinder)
{
    ...
    rangefinder->distance_2 = mavlink_msg_rangefinder_get_distance_2(msg);
    rangefinder->voltage_2 = mavlink_msg_rangefinder_get_voltage_2(msg);
#else
