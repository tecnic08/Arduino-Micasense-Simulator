...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_SET_RNGFND_LPF=31015, /* A command to set rangefinder filter lowpass and apply immediately. |Lowpass cutoff frequency|  */
   MAV_CMD_GET_OVERRIDE_LOC=31016, /* A command to request for a manual control override position. |This must be 1 to request|  */
   MAV_CMD_FS_BATTERY_OVERRIDE=31017, /* A command to request for a continue or RTL in the event of battery failsafe. |1 for continue, 2 for RTL|  */
   MAV_CMD_WATER_OUT_OVERRIDE=31018, /* A command to request for a continue or RTL in the event of water outage. |1 for continue, 2 for RTL|  */
   MAV_CMD_SET_SPRAYER_RUN=31019, /* A command to run sprayer libraries |1 on, 0 off|  */
   MAV_CMD_SET_ALLOW_SPRAY=31020, /* A command to allow spray |1 on, 0 off|  */
   MAV_CMD_REQUEST_SYSTEM_ID=31021, /* A command to request for system id. |nothing need to be filled|  */
   MAV_CMD_SET_ALLOW_MANUAL_ALTITUDE_CONTROL=31022, /* A command to allow pilot to control the drone altitude in auto mission. |1 enable, 0 disable|  */
